...
--[------------------------------[ Libraries ]---------------------------------]--
local repo = 'https://raw.githubusercontent.com/A-Lag/Pilgrammed/main/'
local lib = loadstring(game:HttpGet(repo .. 'Library.lua'))() --local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/A-Lag/Pilgrammed/main/Library.lua"))()
...
local window = lib:CreateWindow({
	Title = "INSANELY OP ESP/AUTOFARM | Pilgrammed",
	Center = true,
	AutoShow = true,
})
...
local oregroup = Tabs.esptab:AddRightGroupbox("Mining")
...
fishgroup:AddLabel("This obviously requires")
fishgroup:AddLabel("a fishing rod")
--[[
...
for i,v in pairs(goldchests:GetChildren()) do
    if v:FindFirstChild("Root",true) then
        ...
        zlib:text(root,-2, 0,"Chest",{
            Text = "Premium Chest",
            Color = Color3.fromRGB(0, 255, 189),
            Visible = false,
            Outline = true,
            OutlineColor = Color3.fromRGB(0, 0, 0),
            Center = true,
...
lib:Notify("Made by zell#1337") -- For Credits (Don't remove)
